...
public class TestBase {
   ...
   // @AfterMethod(enabled = true)
    ...
    public void fillContactForm(String Name, String LastName, String phone, String email, String adress, String deskription) {
        ...
        //Enter address
        type(By.cssSelector("input:nth-child(5)"), adress);
        //Enter description
        type(By.cssSelector("input:nth-child(6)"), deskription);
